---
title: Comparer Interface
description: Interface for comparing perceptual hashes using appropriate distance metrics
---
...
<ParamField path="Compare" type="func(hashtype.Hash, hashtype.Hash) (similarity.Distance, error)">
