---
title: HOGHash (Histogram of Oriented Gradients)
description: HOG-based perceptual hash for shape and object recognition
---
...
<ResponseField name="WithSize" type="func(width, height uint) SizeOption">
...
<ResponseField name="WithInterpolation" type="func(interp Interpolation) InterpolationOption">
...
<ResponseField name="WithCellSize" type="func(size uint) CellSizeOption">
...
<ResponseField name="WithNumBins" type="func(bins uint) NumBinsOption">
...
<ResponseField name="WithDistance" type="func(fn DistanceFunc) DistanceOption">
