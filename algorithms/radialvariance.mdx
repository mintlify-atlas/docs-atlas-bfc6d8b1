---
title: RadialVariance
description: Radial variance-based perceptual hash for robust image matching
---
...
<ResponseField name="WithSigma" type="func(sigma float64) SigmaOption">
...
<ResponseField name="WithAngles" type="func(angles int) AnglesOption">
