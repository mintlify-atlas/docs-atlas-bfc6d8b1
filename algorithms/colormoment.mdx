---
title: "ColorMoment"
description: "Float64 perceptual hash using color invariant moments from YCrCb and HSV color spaces"
---
...
<ParamField path="width" type="uint" default="512">
  Image resize width
</ParamField>

<ParamField path="height" type="uint" default="512">
  Image resize height
</ParamField>

<ParamField path="interpolation" type="Interpolation" default="Bicubic">
  Resize interpolation method
</ParamField>

<ParamField path="kernel" type="int" default="3">
  Gaussian kernel size (must be > 0)
</ParamField>

<ParamField path="sigma" type="float64" default="0">
  Gaussian kernel standard deviation (0 = auto-calculate)
</ParamField>

<ParamField path="distanceFunc" type="DistanceFunc" default="similarity.L2">
