---
title: "GIST"
description: "Float64 holistic scene descriptor using oriented Gabor filters on a spatial grid"
---
...
<ParamField path="width" type="uint" default="64">
  Image resize width
</ParamField>

<ParamField path="height" type="uint" default="64">
  Image resize height
</ParamField>
...
<ParamField path="gridX" type="uint" default="4">
  Number of grid cells in X direction (must be > 0)
</ParamField>

<ParamField path="gridY" type="uint" default="4">
  Number of grid cells in Y direction (must be > 0)
</ParamField>

<ParamField path="distanceFunc" type="DistanceFunc" default="similarity.Cosine">
