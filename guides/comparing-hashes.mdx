...
description: Learn how to compare perceptual hashes and interpret distance metrics
---
...
<AccordionGroup>
  <Accordion title="Binary Hashes (Hamming Distance)">
  ...
  <Accordion title="Float64 Hashes">
...
<CardGroup cols={2}>
  <Card title="Practical Examples" icon="code" href="/guides/examples">
    See complete examples for common use cases
  </Card>
  <Card title="API Reference" icon="book" href="/api/similarity">
    Explore distance metric documentation
  </Card>
</CardGroup>