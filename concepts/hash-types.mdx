---
title: 'Hash Types'
description: 'Understanding Binary, UInt8, and Float64 hash representations in imghash'
---
...
<Tabs>
  ...
  <Tab title="SetReverse (MSB first)">
    ```go
    hash := hashtype.NewBinary(16)
...
<ParamField path="ValueAt(idx)" type="float64">
...
<ParamField path="Equal(other)" type="bool">
